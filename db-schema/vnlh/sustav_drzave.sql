CREATE TABLE `sustav_drzave` (
  ...
  `slika_naziv` varchar(150) DEFAULT NULL COMMENT 'Naziv sloga u sustav_slike_tekstovi koji nosi zastavu ove države (npr. "Zastava Srbija"). Po njemu php/zastava.php dohvaća sliku; admin tako zna kako nazvati slog. Prazno = bez slike (prazan okvir).',
