...
CREATE TABLE `pdf_tablica_stil_kolona` (
  ...
  `zag_orijentacija`      enum('lijevo','centar','desno') NOT NULL DEFAULT 'lijevo' COMMENT 'H poravnanje ćelije zaglavlja',
  `zag_valign`            enum('gore','centar','dolje') NOT NULL DEFAULT 'gore' COMMENT 'V poravnanje ćelije zaglavlja (pdfmake valign)',
  ...
  `pod_orijentacija`      enum('lijevo','centar','desno') NOT NULL DEFAULT 'lijevo' COMMENT 'H poravnanje ćelije podataka',
  `pod_valign`            enum('gore','centar','dolje') NOT NULL DEFAULT 'gore' COMMENT 'V poravnanje ćelije podataka (pdfmake valign)',
