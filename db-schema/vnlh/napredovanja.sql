CREATE TABLE `napredovanja` (
  ...
  `id_clanovi` int(11) unsigned NOT NULL,
  `id_stupanj` int(11) unsigned NOT NULL,
  `id_tip_napredovanja` int(11) unsigned DEFAULT NULL,
  `id_loza_napredovanja` int(11) unsigned DEFAULT NULL,
