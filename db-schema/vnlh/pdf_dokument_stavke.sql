CREATE TABLE `pdf_dokument_stavke` (
  ...
  `izvor_tip`        enum('staticki','dinamicki','po_vrijednosti') NOT NULL COMMENT 'staticki=fiksni red; dinamicki=id iz konteksta; po_vrijednosti=red po vrijednosti kolone',
