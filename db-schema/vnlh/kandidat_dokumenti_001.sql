...
CREATE TABLE `kandidat_dokumenti_001` (
  ...
  `sekretar_id`        int(11) unsigned DEFAULT NULL COMMENT 'Obrazac 001b: ID sekretara (clanovi.id)',
  ...
  KEY `fk_kd001_sekretar` (`sekretar_id`),
  ...
  CONSTRAINT `fk_kd001_sekretar` FOREIGN KEY (`sekretar_id`) REFERENCES `clanovi` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
