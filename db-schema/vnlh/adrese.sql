CREATE TABLE `adrese` (
  ...
  CONSTRAINT `fk_adrese_adrese_tip` FOREIGN KEY (`id_adrese_tip`) REFERENCES `adrese_tip` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_adrese_clanovi` FOREIGN KEY (`id_clanovi`) REFERENCES `clanovi` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_adrese_drzave_adresa` FOREIGN KEY (`id_drzave_adrese`) REFERENCES `drzave_adresa` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
