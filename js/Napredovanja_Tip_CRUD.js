      ...
      if (jeIzmjena) {
        ...
        napredovanjaTipUpdate(id, naziv, function (res) {
          if (res === 'OK') {
            ...
            if (p && typeof MODAL_MESSAGES !== 'undefined' && MODAL_MESSAGES[p.code] && typeof window.showPorukaModal === 'function') window.showPorukaModal(p.code, p.code === '002' ? ['tip napredovanja'] : p.replacements);
          }
        });
      } else {
