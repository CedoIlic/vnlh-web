...
(function () {
  ...
  /* Boje redaka (Lista i Članovi dijele isti izvor): zapisnik_boje_u_listi id 20 = kandidat, id 21 = privremeni otpust. */
  ...
  function ucitajClanoviBojeUListi() {
    ...
    xhr.onreadystatechange = function () {
      ...
      if (tablicaApi && typeof tablicaApi.getData === 'function') {
        clanoviPrimijenKandidatStil(tablicaApi.getData());
      }
    };
    xhr.send();
  }
  ...
  function azurirajOtpustZaglavlje(found) {
    ...
    if (!zaglavlje) {
      ...
      zaglavlje.className = 'clanovi-crud__otpust-zaglavlje';
      panel.insertBefore(zaglavlje, panel.firstChild);
    }
