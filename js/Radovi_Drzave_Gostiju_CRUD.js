...
// =============================================================================
  ...
  /* Prijevod zaglavlja tablice iz jednog ključa (naslovi zarezom: "Redosljed, Naziv"). 0-Jezik.js je sinkron →
     vnlhT je spreman ovdje; na master jeziku / bez prijevoda vraća originalne naslove. */
  if (window.vnlhTZaglavlje) {
    Radovi_DrzaveGostijuCRUD.Tablica_Zaglavlje = window.vnlhTZaglavlje('radovi_drzave_gostiju_crud.tablica.zaglavlje', Radovi_DrzaveGostijuCRUD.Tablica_Zaglavlje);
  }
  ...
  function prikaziGresku(res) {
    ...
    if (p.code === '002') {
      var tt = window.vnlhT || function (k, f) { return f != null ? f : k; };
      repl = [tt('radovi_drzave_gostiju_crud.labela.naziv', 'Naziv')];
    }
