...
// Upis SAMO množitelja extra-proreda dokumenta (zapisnik_sa_radova.dokument_prored, decimal(3,2)).
// Korisnički zadatak u aplikaciji: korisnik podešava prored gotovog/testiranog PDF zapisnika.
// Ulaz: POST JSON { id, prored }. Klamp 0.80–2.00 (kao stepper na klijentu).
// Zrcalo Esej_CRUD_prored.php (eseji.dokument_prored).
...
try {
    $stmt = $mysqli->prepare('UPDATE zapisnik_sa_radova SET dokument_prored = ? WHERE id = ?');
