...
// Clanovi_CRUD_sve_neaktivni.php – dohvat SAMO NEAKTIVNIH članova za ložu (aktivnost = 0). GET id_loza.
// Isti oblik odgovora kao Clanovi_CRUD_sve.php; razlika je samo WHERE uvjet.
